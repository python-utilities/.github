...
[heading__opening_issues]:
  #opening-issues
  "Issues are a great way to show that you care about what Python Utilities maintains!"


Issues are a great way to show that you care about what Python Utilities maintains, please search existing issues prior to opening new issues, and utilize the following templates when applicable.
...
[heading__pull_requests]:
  #pull-requests
  "Be a hero to Python Utilities with quality Pull Requests"


Be a hero to Python Utilities by making quality Pull Requests with the following templates, or utilize the [General Pull Request][branch__current__template__pull_requests__general] template.


### Bug Fixes
[heading__bug_fixes]:
  #bug-fixes
  "Squish'em good! And tell Python Utilities all about it"


Squish'em good! And tell Python Utilities all about it though use of the [Bug Fix][branch__current__template__pull_requests__bug_fix] template.
